...
{
    public class RegistrarDanioValidator : AbstractValidator<RegistrarDanioDto>
    {
        public RegistrarDanioValidator()
        {
            ...
            RuleFor(x => x.Motivo)
                .NotEmpty().WithMessage("El motivo del daño es obligatorio.")
